		...
		<footer className="bg-white shadow-lg mt-24 p-4 flex flex-col space-y-2 md:lg:flex-row md:lg:space-y-0 items-center justify-between dark:bg-[#1a1a1a]">
			<div className="text-md dark:text-gray-300">
				⚙️ Built by <a
					...
					className="underline"
				>
					Shubham Chandra Mishra
				</a>
			</div>

			<div className="flex items-center space-x-2">
				<a
					href="https://twitter.com/intent/tweet?text=Checkout%20musicforcode.vercel.app%20by%20@shubh6200%0A%0AMusic%20🎵%20to%20keep%20you%20on%20while%20coding%20💻"
					target="_blank"
				...
				<a
					href="https://www.buymeacoffee.com/scmishra"
					target="_blank"
